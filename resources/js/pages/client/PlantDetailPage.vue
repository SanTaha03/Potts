...
const plant = computed(() => {
    ...
    return {
        ...
        location: d.location
            ? `${d.location.site ?? ""} ${d.location.floor ? "" + d.location.floor : ""}`
            : "Non localisé",
        tag: `#${d.device_id}`,
        exposure: {
        ...
        image: (() => {
            ...
            if (name.includes("monstera") || slug.includes("monstera")) {
                return "/images/monstera.png";
            } else if (
                name.includes("strelitzia") ||
                slug.includes("strelitzia")
            ) {
                return "/images/strelitzia.png";
            } else if (name.includes("pachira") || slug.includes("pachira")) {
                return "/images/pachira-aquatica.png";
            } else if (name.includes("ficus") || slug.includes("ficus")) {
                return "/images/ficus-latara.png";
            } else if (name.includes("basilic") || slug.includes("basilic")) {
                return "/images/plante_stickers.png";
            }
            return "/images/monstera.png"; // fallback
        })(),
...
const healthPolyline = computed(() => {
    ...
    return weeklyHealth.value
        .map((value, index) => {
            const x =
                (index / Math.max(weeklyHealth.value.length - 1, 1)) * 100;
    ...
    <div class="relative min-h-screen w-full bg-white font-popins pb-20">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex flex-col">
                    <div class="flex items-center gap-3">
                        ...
                        <span
                            class="rounded-md bg-[#EDE5FF] px-1.5 py-1 text-sm font-bold text-[#2E0099] text-nowrap"
                        >
                            {{ plant.location }}
                        </span>
                    </div>
        ...
        <main class="space-y-4">
            ...
            <div class="relative h-[380px] w-full">
                ...
                >
                    <img
                        :src="plant.image"
                        alt="Monstera"
                        class="h-full w-full object-contain sm:object-contain"
                    />
                ...
                <div
                    class="absolute right-0 top-0 flex w-[120px] flex-col gap-3 z-10"
                >
                    <!-- Temp Card -->
                    <div
            ...
            <div class="rounded-3xl bg-[#F7F7F8] px-4 pt-4 pb-11">
                <div class="mb-4 flex items-center gap-2">
                    <Icon
                        icon="ph:heart-fill"
                        class="text-base text-dark-green-2"
                    />
                    <h2 class="font-popins font-bold text-dark-green-2">
                        Santé global
                    </h2>
                </div>
                ...
                <div class="relative h-24 w-full">
                    ...
                    <!-- X Axis -->
                    <div
                        class="absolute bottom-0 left-0 right-0 border-t border-[#747F8B]"
                    ></div>
                    <div
                        class="mt-2 flex justify-between text-[10px] font-bold uppercase text-[#454C54]"
                    >
                        <div
                            v-for="day in [
                                'Lun',
            ...
            <div class="rounded-3xl bg-[#F7F7F8] p-4">
                <div class="mb-3 flex items-center gap-2">
                    <Icon
                        ...
                        class="text-base text-dark-green-2"
                    />
                    <!-- Grass icon replacement -->
                    <h2
                        class="font-popins text-base font-bold text-dark-green-2"
                    >
                        Descriptif de la plante
                    </h2>
                </div>
                <div
                    class="text-xs leading-relaxed text-[#454C54] text-justify"
                >
                    <p
                        v-for="(paragraph, index) in plant.description.split(
                            '\n\n',
                        )"
                        :key="index"
            ...
            <div class="rounded-3xl bg-[#F7F7F8] p-4">
                <div class="flex justify-between items-center mb-4">
                    <div class="flex items-center gap-2">
                        ...
                        />
                        <h2
                            class="font-popins font-bold text-base text-dark-green-2"
                        >
                            Plante du même étage
                        </h2>
                    </div>
                    <button
                        type="button"
                ...
                <div class="flex flex-col gap-3">
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-8 w-8 items-center justify-center rounded-full bg-[#f6f6f6]"
                            >
                                <Icon
                                    :icon="item.icon"
                                    class="h-5 w-5"
                            ...
                            <div>
                                <p
                                    class="font-semibold text-xs text-dark-green-2"
                                >
                                    {{ item.name }}
                                </p>
                                <p
                                    class="text-[10px] text-[#747F8B] opacity-75"
                                >
                                    Santé : {{ item.health }}%
                                </p>
                            </div>
                        ...
                        <div
                            class="relative h-6 w-6 flex items-center justify-center rounded-full bg-[#F1F2F3]"
                        >
                            <Icon
                                icon="ph:drop-fill"
                                class="h-3 w-3 text-[#2072DF] z-10"
                            />
                            ...
                            >
                                ...
                                <circle
                                    ...
                                    :stroke-dashoffset="62.8 * (1 - item.water)"
                                />
                            </svg>
                        </div>
                    </div>
        ...
        <div class="fixed bottom-3 right-0 z-40 mx-5">
            ...
            >
                Signaler une anomalie
                <div
                    class="flex h-4 w-4 items-center justify-center rounded-full bg-[#2F2C36]"
                >
        ...
        <BottomSheet
            v-model="showAnomalySheet"
            :showClose="false"
            title="Fiche anomalie"
        >
            <div class="space-y-6 pb-24 p-1">
                <!-- Heading Info -->
                <div class="">
                    <div class="flex items-center gap-2">
                        <span class="text-base font-bold text-[#454C54]">{{
                            plant.name
                        }}</span>
                        <span
                            class="rounded-[6px] bg-[#F1F2F3] px-1.5 py-1 text-xs font-bold text-[#454C54]"
                        >
                            {{ plant.location }}
                        </span>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2 relative">
                        <label class="text-base font-medium text-dark-green-2"
                            >Localisation de l'incident</label
                        >
                        <div class="relative">
                            <button
                                type="button"
                            ...
                            >
                                <div class="py-1 flex flex-col">
                                    <button
                                        ...
                                        :class="{
                                            'bg-[#EFFBD0] text-[#475F07] font-bold':
                                    ...
                                    >
                                        {{ floor }}
                                        <Icon
                                            v-if="selectedLocation === floor"
                                            icon="ph:check-bold"
                                            class="absolute right-3 top-1/2 -translate-y-1/2 text-[#475F07]"
                                        />
                                    </button>
                                </div>
                            </div>
            ...
            <div
                class="fixed bottom-8 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-2xl p-2 z-50"
            >
                <button
