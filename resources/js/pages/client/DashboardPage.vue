...
<template>
    <section class="grid gap-6 ">
        ...
        <div class="space-y-4 rounded-2xl bg-white p-5 mt-2 h-fit">
            ...
            <ul class="space-y-3">
                <li
                    ...
                    :key="visit.id"
                    class="flex items-center justify-between bg-gray-100 rounded-xl px-4 py-3 text-sm text-[#4e4439]"
                >
                    <div class="flex items-center gap-3">
                        <span
                            class="flex h-6 w-6 items-center justify-center rounded-xl" >
                            <Icon :icon="visit.icon" class="text-xl" />
                        </span>
                        <div>
        ...
        <div class="space-y-4 rounded-2xl bg-white p-5 h-fit">
            <header class="flex items-center justify-between">
                ...
                <button
                    type="button"
                    class="flex items-center gap-1 font-popins rounded-lg bg-[#EEEEEE] px-4 py-2 text-xs text-black"
                    @click="goToPlants"
                >
                    Voir tout
                </button>
