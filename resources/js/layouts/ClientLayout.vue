<template>
  <div 
    class="relative flex min-h-screen flex-col text-slate-900" 
    :class="{ 'pb-[80px]': isAuthenticated && route.meta.showBottomNav }"
  >
    ...
    <BottomNav v-if="isAuthenticated && route.meta.showBottomNav" />
  </div>
</template>
