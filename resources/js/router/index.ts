...
const RseReportPage = () => import("@/pages/client/RseReportPage.vue");
...
const TechPlantDetailPage = () =>
    import("@/pages/tech/TechPlantDetailPage.vue");
        ...
        // --- CLIENT ROUTES ---
        {
            ...
            children: [
                ...
                },
                {
                    path: "rse-report",
                    name: "rse-report",
                    component: RseReportPage,
                    meta: { title: "Rapport RSE", showBottomNav: false },
                },
            ],
        },
    ],
